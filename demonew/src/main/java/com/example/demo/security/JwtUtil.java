...
public class JwtUtil {
    ...
    // 🔥 แก้แล้ว: Key ยาวสะใจ ไม่ Error แน่นอน
    ...
    private Key getSigningKey() {
        // แปลง String เป็น Key ที่ถูกต้อง
        // (เทคนิค: Encode เป็น Base64 ก่อน แล้วค่อย Decode กลับเพื่อให้ได้ format ที่ Library ชอบ)
